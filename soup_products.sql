...
INSERT INTO soup_products (productName, productDescription, calories, productPrice, webPageLink, allergies, ingredients, productImg)
VALUES
("Italian Wedding Soup", "A delicious bowl of comfort.", 570, 4.00, "italian-wedding.php", "None", "Beef/pork meatballs, carrots, onion, celery, garlic, chicken broth, pasta, spinach", "img/italian_wedding_soup.jpg");
